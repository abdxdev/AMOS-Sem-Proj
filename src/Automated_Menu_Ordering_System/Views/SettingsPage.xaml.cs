...
public sealed partial class SettingsPage : Page
{
    ...
    private async void SignOutCommand(object sender, RoutedEventArgs e)
    {
        ...
        if (LocalUserType == "Customer")
        {
            ...
            {
                var reader = App.GetService<DatabaseService>().get_manager_by_table_id(LocalUserId);
                reader.Read();
        ...
        //var keyCredentialRetrievalResult = await KeyCredentialManager.OpenAsync("Automated_Menu_Ordering_System");
        //if (keyCredentialRetrievalResult.Status == KeyCredentialStatus.NotFound)
        //{
        //    var keyCredentialCreationResult = await KeyCredentialManager.RequestCreateAsync("Automated_Menu_Ordering_System", KeyCredentialCreationOption.ReplaceExisting);
        //    if (keyCredentialCreationResult.Status == KeyCredentialStatus.Success)
        //    {
        //        keyCredentialRetrievalResult = await KeyCredentialManager.OpenAsync("Automated_Menu_Ordering_System");
        //    }
        //}
