---
title: Requirements
description: 'Learn about the functional and non-functional requirements, actors, business rules, business requirements, physical requirements, and development constraints of the Automated Menu Ordering System.'
---
